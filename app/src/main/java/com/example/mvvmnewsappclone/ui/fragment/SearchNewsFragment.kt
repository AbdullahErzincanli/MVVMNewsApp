...
import com.androiddevs.mvvmnewsapp.ui.util.Constant
import com.androiddevs.mvvmnewsapp.ui.util.Constant.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment: Fragment(R.layout.fragment_search_news) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val firsVisibleItemPosition = layoutManager.findFirstCompletelyVisibleItemPosition()
